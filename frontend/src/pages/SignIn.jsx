  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' 
      style={{backgroundImage: `url(${bg})`}}>
        <form className='w-[90%] h-[600px] max-w-[500px] bg-[#0000003a] backdrop-blur shadow-lg shadow-blue-950 flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
             ...
             <p className='text-white text-[18px]'>Want to create new account ? <span className='text-blue-400 cursor-pointer underline' onClick={() => navigate('/signup')}>Sign Up</span></p>
        </form>
    </div>
  )
}
